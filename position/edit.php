...
<ul class="nav">
	...
	<h3>Update Position <?php echo $position; ?></h3> 
...
<form action="/position/<?php echo $position; ?>/edit" method="post">
	
	
<?php	
$x=0;
$SQL_sh		= "SELECT * FROM rota WHERE position='$position' ORDER BY week";
...
<li><input name="tuesday[]" type="text" id="tuesday" value="<?php echo $rows['tuesday']; ?>" placeholder="tue" ></li>
	...
	<li><input name="thursday[]" type="text" id="thursday" value="<?php echo $rows['thursday']; ?>" placeholder="th" ></li>
