...
<ul class="nav">
	<li><a class="selection" href="/manage/week/<?php echo $week-1; ?>">Previous</a></li> 
	<li><a class="selection" href="/manage/week/<?php echo $week+1; ?>">Next</a></li>
</ul>
...
<?php	
$SQL_sh		= "SELECT * FROM rota WHERE week='$week' ORDER BY username";
